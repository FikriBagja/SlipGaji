...
<body>
    ...
    <div class="content">
        ...
        <div class="rincian-gaji">
            ...
            <table width="100%">
                <tr>
                    @if (isset($rincian_gaji['rincian']) && (isset($rincian_gaji['potongan']) || isset($rincian_gaji['tambahan'])))
                        <td width="50%">
                            @if (isset($rincian_gaji['rincian']))
                                <div class="card">
                                    <h3>Rincian</h3>
                                    <table>
                                        <tr>
                                            ...
                                            <td style="text-align: right;">
                                                <p>{{ $rincian_gaji['rincian']['gaji_pokok'] }}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span>Bonus Tindakan</span></td>
                                            <td style="text-align: right;">
                                                <p>{{ $rincian_gaji['rincian']['bonus_tindakan'] }}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span>Bonus Pasien Baru</span></td>
                                            <td style="text-align: right;">
                                                <p>{{ $rincian_gaji['rincian']['bonus_pasien_baru'] }}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span>Bonus Upah Lembur</span></td>
                                            <td style="text-align: right;">
                                                <p>{{ $rincian_gaji['rincian']['bonus_upah_lembur'] }}</p>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="text-align: right;">
                                                <p>{{ $rincian_gaji['potongan']['total_potongan'] }}</p>
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    @elseif(isset($rincian_gaji['rincian']))
                        <td colspan="2">
